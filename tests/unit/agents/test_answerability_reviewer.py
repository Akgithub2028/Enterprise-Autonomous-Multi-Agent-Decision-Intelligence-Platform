...
def _answerable() -> AnswerabilityDecision:
    return AnswerabilityDecision(
        ...
        decision_reason="Selected evidence directly provides the required condition.",
    )
...
def _unanswerable() -> AnswerabilityDecision:
    return AnswerabilityDecision(
        ...
        missing_information="New free warranty period after repair is completed",
        decision_reason="Selected evidence does not provide the new free warranty period after repair.",
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"answerability": "unanswerable", "decision_reason": "reason"},
        {"answerability": "answerable", "missing_information": None, "decision_reason": "   "},
        {"answerability": "failed", "missing_information": None, "decision_reason": "reason"},
        {
            "answerability": "answerable",
            "missing_information": None,
            "decision_reason": "reason",
...
def test_chinese_query_prompt_repeats_mandatory_simplified_chinese_constraints() -> None:
    ...
    assert "The selected Evidence directly states the required policy." in _SYSTEM_PROMPT
    assert "the requested effective date" in _SYSTEM_PROMPT
