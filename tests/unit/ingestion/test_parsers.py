...
def test_utf8_txt_preserves_multilingual_content(tmp_path: Path) -> None:
    path = tmp_path / "sample.txt"
    path.write_text("East China regional sales analysis", encoding="utf-8")

    assert parse_text(path)[0].content == "East China regional sales analysis"
