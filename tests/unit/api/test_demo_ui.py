...
def test_html_has_accessible_form_status_and_result_regions() -> None:
    ...
    assert 'aria-label="Service Status"' in html
    ...
    assert "Enterprise Knowledge" in html
    ...
    with _client() as client:
        ...
        response = client.post(
            ...
            json={
                ...
                "query": "Please answer an enterprise question.",
            },
        )
...
def test_script_distinguishes_unsupported_from_execution_failure() -> None:
    ...
    assert 'label: "Unsupported"' in script
    assert 'message: "The Agent does not currently support this type of request."' in script
