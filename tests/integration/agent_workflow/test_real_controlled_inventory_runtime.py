...
_USER_QUERY = (
    "Please identify priority inventory risks based on safety stock, reorder trigger, "
    "and emergency handling rules in the enterprise inventory policy combined with current product inventory data, "
    "distinguishing policy basis from data facts and providing corresponding action recommendations."
)
