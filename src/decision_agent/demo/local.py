...
DEMO_SPECIFICATIONS: Mapping[DemoCase, DemoSpecification] = MappingProxyType(
    {
        DemoCase.KNOWLEDGE: DemoSpecification(
            question="What are the business positioning and demonstration scope of Huaheng Intelligent Technology Co., Ltd.?",
            scenario="knowledge",
            workflow="direct",
        ...
        DemoCase.DATA: DemoSpecification(
            question="As of June 30, 2026, which products are below safety stock?",
            scenario="data",
            workflow="direct",
        ...
        DemoCase.MIXED: DemoSpecification(
            question=(
                "Based solely on current inventory data and DOC-INV-001 Inventory Safety Threshold and Replenishment Policy, "
                "analyze inventory risks as of June 30, 2026; provide a risk overview, policy basis, and action recommendations, "
                "with both data and knowledge citations."
            ),
            scenario="mixed",
