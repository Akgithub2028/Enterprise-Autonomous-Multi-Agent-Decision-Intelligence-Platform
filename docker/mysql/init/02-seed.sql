...
INSERT INTO products (product_id, sku, product_name, category, status, safety_stock) VALUES
    ('P100', 'PUMP-A1', 'Aster Industrial Pump', 'Pumps', 'active', 50),
    ('P200', 'VALVE-B1', 'Boreal Control Valve', 'Valves', 'active', 80),
    ('P300', 'SENSOR-C1', 'Cirrus Sensor', 'Sensors', 'active', 100),
    ('P400', 'DRIVE-D1', 'Delta Drive', 'Drives', 'active', 40),
    ('P500', 'FILTER-E1', 'Echo Filter', 'Filters', 'discontinued', 30),
    ('P600', 'CABLE-F1', 'Flux Industrial Cable', 'Cables', 'active', 120),
    ('P700', 'METER-G1', 'Grove Flow Meter', 'Meters', 'active', 60),
    ('P800', 'SEAL-H1', 'Harbor Seal', 'Seals', 'active', 200);

INSERT INTO suppliers (supplier_id, supplier_name, status) VALUES
    ('S100', 'Anhai Manufacturing', 'active'),
    ('S200', 'Beichen Supply', 'active'),
    ('S300', 'Changjiang Industries', 'active'),
    ('S400', 'Dongfang Components', 'active');
