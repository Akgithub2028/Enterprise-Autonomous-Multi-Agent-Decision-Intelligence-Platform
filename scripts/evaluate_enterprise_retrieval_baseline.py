...
WARMUP_QUERY = "Enterprise policy and workflow retrieval validation"
CLI_EXAMPLES = (
                ...
                cli_summaries.append(
                    {
                        ...
                        "retrieval_only_notice": "Retrieval evidence only, no LLM answer generated",
                    }
                )
...
async def _run(args: argparse.Namespace) -> int:
    ...
    runtime_profile = {
        "schema_version": SCHEMA_VERSION,
        "baseline_id": BASELINE_ID,
        "measurement_scope": "Local CPU single observation",
        "execution_contract": {
            "run_order": ["A", "B"],
